...
import com.PlushiePro.PlushiePro.service.*;
import com.PlushiePro.PlushiePro.domain.Usuario;
import com.PlushiePro.PlushiePro.service.CorreoService;
import com.PlushiePro.PlushiePro.service.RegistroService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    public void activar(Usuario usuario) {
        ...
        usuarioService.actualizar_user(usuario);
    }
    ...
    public Model recordarUsuario(Model model, Usuario usuario) 
        ...
        if (usuario2 != null) {
            ...
            usuarioService.actualizar_user(usuario2);
